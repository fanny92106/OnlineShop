			...
			<table class="table table-bordered" id="prod">
				<tbody>
					<tr>
						<td>Prodcut Image</td>
						<td><img
							src="<c:url value="/resource/images/products/${product.id}.jpg" />"
					...
					<tr>
						...
						<td><security:authorize access="hasRole('ROLE_USER')">
								<a href="/onlineShop/cart/add/${product.id}" class="btn btn-info"
									style="margin-top: 0px; width: 150px; float: left; margin-right: 31px;">
									<span class="glyphicon glyphicon-shopping-cart"></span>
								</a>

							</security:authorize> <a href="<c:url value="/getAllProducts" />" class="btn btn-info"
